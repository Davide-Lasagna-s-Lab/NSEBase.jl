@testset verbose=true "Migrated case docstrings                                    " begin
    ...
    migrated_bindings = (
        :CHANNEL_2D3C_AXES, :CHANNEL_2D3C_FFT_ORDER, :CHANNEL_2D3C_INHOMOGENEOUS_DIMS,
        ...
        :AbstractChannelGrid, :AbstractChannel2D3CGrid, :AbstractChannel3DGrid,
        :AbstractSquareDuctGrid, :AbstractLidDrivenCavityGrid, :AbstractLidDrivenCavity3DGrid,
        :RectangularGrid, :ChannelGrid, :SquareDuctGrid, :LidDrivenCavityGrid,
        ...
        :CartesianPrimitive3D, :CartesianPrimitive2D3C, :CartesianPrimitive3DBoussinesq,
        :CoriolisForce, :ConstantBodyForce,
        :plane_couette_base, :plane_poiseuille_base, :rpcf_base,
