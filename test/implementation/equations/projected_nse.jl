@testset verbose=true "Projected Navier-Stokes equations                           " begin
    ...
    op = construct_equations(g, 100, base, CartesianPrimitive3D(); mode=AdjointDiscrete(), flags=FFTW.ESTIMATE)
    @test op.cache1 isa VectorField{3, <:FTField{typeof(g)}}
    @test op.cache2 isa VectorField{3, <:FTField{typeof(g)}}
