...
@testset verbose=true "VectorField contract                                        " begin
    ...
    @testset verbose=true "array-like wrapper semantics are component-wise             " begin
        Nx, Ny = 7, 9
    ...
    @testset verbose=true "add_base_flow! touches only the homogeneous DC slice        " begin
        Ny, Nx, Nz = 7, 9, 5
        ...
        # The zero homogeneous slice is (:, 1, 1) because
